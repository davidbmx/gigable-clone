...
const socialStyle = {width: '32px', height: '32px'};
const contentSocial = {padding: '5px'};

const SocialButtons = () => {
    return (
        <Fragment>
            <div aria-label="facebook" role="button" style={contentSocial}>
            ...
            <div aria-label="twitter" role="button" style={contentSocial}>
                <div style={socialStyle}>
                    <svg viewBox="0 0 64 64" width="32" height="32">
                        <g>
            ...
            <div aria-label="whatsapp" role="button" style={contentSocial}>
                <div style={socialStyle}>
                    <svg viewBox="0 0 64 64" width="32" height="32">
                        <g>
            ...
            <div aria-label="linkedin" role="button" style={contentSocial}>
                <div style={socialStyle}>
                    <svg viewBox="0 0 64 64" width="32" height="32">
                        <g>
